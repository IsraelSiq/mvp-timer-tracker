      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5 flex-wrap">
            <span className="font-body font-semibold text-rag-text text-sm leading-tight truncate">{data.name}</span>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {timeLeft !== null && (
            <span className={cn(
              ...
              status === 'window-open' ? 'text-green-400' : status === 'soon' ? 'text-yellow-400' : 'text-rag-muted'
            )}>
